...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If (Test-Path "$envProgramFiles\datamodeler-22.2.0.165.1149-x64") {
			Write-Log -Message "Deleting installation files..." -Source 'Pre-Installation' -LogType 'CMTrace'
			Get-ChildItem -Path "$envProgramFiles\datamodeler-22.2.0.165.1149-x64" -Recurse | Remove-Item -force -recurse
			Remove-Item "$envProgramFiles\datamodeler-22.2.0.165.1149-x64" -Force
		}
		Else {
		...
		Copy-Item -Path "$dirFiles\datamodeler-22.2.0.165.1149-x64" -Destination $envProgramFiles -Recurse
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2pZwALhRszS7RGoMp2JmUyXG
# iNygghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFK8eMKRWVaZiWNZ29EIOwKRdWIo4MA0GCSqGSIb3DQEBAQUABIIBgAOaARtM
# zZPlE8LJ14xKxON48nJAUAbcyUyM7rDfrSM17ppHjvTUFnyHhmiIe3Jk1ML82Qnk
# P5eu1WzUuX1UKvo1CwLTz5cGZ1NXxexuPb8gHqmyltfcaTQ6TJoibN10svu6kRay
# B97pPBiVRL5Wz238prYrPKwanQBhLE3lRLD+ZMeeZvmB3Wth8Ts7lI7oQCn0SDWk
# r0cOU5nu2Rxp/F6ykQnEjgqlu5aAtGb13r0grtXovAdssDTKR/QpIozqRXFAJbfw
# 9obJQe5QPhCXB6KOkwU9hnZtkjhCsIdnGoFXWTfIhuIUrJ0dESIZJmfLSKxnelBl
# k16p3mDneerO72CIMd2NESXBzGwBxfWx+4OiYG5n8oC1gxExFIdZLIl5Bkz0q594
# tmpHqXOueP93B130/r4V+FUs3w5NlnU1EJX6k9APTubEym66Hrpn7hXpHuWPmEEl
# 9jS+SgmvM28okFbtWppaVNpVZG52QzmMcBVXGayUXI3RYaINHAIANhgxSg==
